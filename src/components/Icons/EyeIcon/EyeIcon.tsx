...
const EyeIcon: React.FC<IconProps> = ({ color, className = '', width = 24, height = 24, ...props }) => {
  return (
    <Icon color={color}>
        <svg
        ...
        >
            <path xmlns="http://www.w3.org/2000/svg"
                  ...
                  fill="currentColor"/>
            <ellipse xmlns="http://www.w3.org/2000/svg" cx="7.85914" cy="7.97725" rx="1.55446" ry="1.60665"
                     fill="currentColor"/>
        </svg>
    </Icon>
  );
